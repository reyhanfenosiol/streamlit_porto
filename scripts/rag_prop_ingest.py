...
pdf_path = f"{BASE_DIR}/multipage_app/Advisory-Pulse-Januari-2026.pdf"
...
# buat index
index_name = "property-opportunity-2026"
...
chunk_ids = [
    f"property-opportunity-2026-p{chunk.metadata['page']}-c{i}" 
